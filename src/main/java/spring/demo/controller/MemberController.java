...
public class MemberController {
	...
	public ModelAndView search(@ModelAttribute Member member, BindingResult result,  @RequestParam(required = false) String action,
			Map<String, Object> map) {	

		List<Member> listmembers = memberService.getAllMember(member);
