									...
									<tbody id="contents">
										...
										<c:forEach items="${members}" var="member">
											<tr class="row<%=i%>">
												...
												<td><span class="no"><%=i++%></span><input name="id" id="id" type="text"
													value="${member.id }" class="hide"></td>
										...
										<form:form action="member/create" method="POST" id="members"
											...
											<tr id="row1" class="hide">
												...
												<input type="submit" name="action" value="Edit"
													id="edit"   class="hide" /> <br> <input type="submit" name="action"
													value="Cancel" id="cancel" class="hide" /> <br> <input
													type="submit" name="action" value="Delete" id="delete"  class="hide"/>
												<input type="submit" name="action" value="Add"
													id="add" /></td>
											</tr>
									</tbody>
